...
class DefaultLicensePlateWidget extends WidgetBase {
  ...
  public function formElement(FieldItemListInterface $items,
                                                     $delta, array $element, array &$form, FormStateInterface
                                                     $form_state): array {
    $element['details'] = [
        '#type' => 'details',
        '#title' => $element['#title'],
   ...
   * {@inheritdoc}
   */
  public function massageFormValues(array $values, array
                                          $form, FormStateInterface $form_state): array {
  ...
  protected function addCodeField(&$element, FieldItemListInterface $items, $delta, $placeholder_settings): void {
